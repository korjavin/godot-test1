...
* **Skinned** — one `.glb` holding one mesh on a 23-bone MakeHuman rig
  ...
  Primm (bead 5u3.6) and Phoboman (bead 9k9n.1 — mesh built, NOT yet wired: 9k9n.2
  wires it, 9k9n.3 retires his parts) are here.
* **Separate parts** — a folder of GLB parts assembled by a `.tscn` whose
  ...
  PHOBOMAN ALONE, and for good: his sphere body stays generated by owner ruling
  (epic 5u3 NOTES, "yes, sphere"), which is why the self-checks that need a hero on
  each rig kind name him as the limb one.
