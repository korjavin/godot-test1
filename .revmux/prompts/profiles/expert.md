---
description: two agents at xhigh, codex gpt-5.6-sol and claude fable, each carrying all seven lenses — for a plan, or a change nobody wants to get wrong
model: claude/fable:xhigh
agents:
  - {name: sol,   lenses: [bugs, impl, architecture, quality, docs, tests, comments], model: codex/gpt-5.6-sol:xhigh, color: cyan}
  - {name: fable, lenses: [bugs, impl, architecture, quality, docs, tests, comments], color: magenta}
---
