---
description: seven lenses across three claude agents plus a codex bugs+impl peer, so the lens that matters most is read by two models
...
agents:
  ...
  - {name: bugs-codex,  lenses: [bugs, impl], model: codex/gpt-5.6-sol:high, color: yellow}
---
