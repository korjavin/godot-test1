---
description: the bugs and impl lenses on claude opus and again on agy — the owner's two-reviewer pair for muse-written branches (2026-09-07)
model: claude/opus:high
agents:
  - {name: bugs+impl,     lenses: [bugs, impl], color: cyan}
  - {name: bugs+impl-agy, lenses: [bugs, impl], model: agy/gemini-3.1-pro-high:high, color: green}
---
