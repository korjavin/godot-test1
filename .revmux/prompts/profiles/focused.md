---
description: the bugs lens on claude and again on codex, for a small or time-boxed change
model: claude/opus:high
agents:
  - {name: bugs, lenses: [bugs], color: cyan}
  - {name: bugs-codex, lenses: [bugs], model: codex/gpt-5.6-sol:high, color: yellow}
---
